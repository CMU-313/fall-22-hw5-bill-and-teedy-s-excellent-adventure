...
(function (window, angular) {
   ...
   */
	...
	ngTouch.factory('$swipe', [function () {
		...
		function getCoordinates(event) {
			...
			const touches = originalEvent.touches && originalEvent.touches.length > 0 ? originalEvent.touches : [originalEvent];
  ...
  */
   ...
   */
	...
	var ngTouchClickDirectiveFactory = ['$parse',
		'$timeout',
		'$rootElement',
		function ($parse, $timeout, $rootElement) {
			...
			function onClick(event) {
				...
				const touches = event.touches && event.touches.length > 0 ? event.touches : [event];
          ...
          && lastLabelClickCoordinates[0] === x && lastLabelClickCoordinates[1] === y) {
			...
			return function (scope, element, attr) {
				...
				element.on('touchend', event => {
					...
					// Use jQuery originalEvent
					const originalEvent = event.originalEvent || event;
					const touches = (originalEvent.changedTouches && originalEvent.changedTouches.length > 0)
						? originalEvent.changedTouches
						: ((originalEvent.touches && originalEvent.touches.length > 0) ? originalEvent.touches : [originalEvent]);
					const e = touches[0];
					const x = e.clientX;
					const y = e.clientY;
